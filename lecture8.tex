...
\includegraphics[scale=1.1,alt={Phase plane graph of p-prime versus p for p-prime as a quadratic function of p}]{pprimeversusp.pdf}

    \caption{A phase plane}
\end{figure}
...
\begin{figure}[ht]
 ...
 \includegraphics[scale=1.1,alt={Same phase plane as on previous page, but with arrows in the p-axis.}]{pprimeversuspwitharrows.pdf}
...
\begin{figure}[ht]
 ...
 \includegraphics[scale=1.2,alt={Phase plane graph of y-prime versus y for y-prime as a quadratic function of y.}]{anotherwitharrows.pdf}
...
\includegraphics[scale=1.2,alt={Phase plane graph of y-prime versus y for y-prime as a cubic function of y.}]{yetanotherwitharrows.pdf}
...
\begin{figure}[ht]
 ...
 \includegraphics[scale=1,alt={Phase plane graph of y-prime versus y for y-prime as a sinusoidal function of y.}]{annoyinggraphic.pdf}
