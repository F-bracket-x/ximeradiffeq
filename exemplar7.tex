...
\newpage
 ...
 \begin{enumerate}
    \item  By multiplying both sides by $y^{\,\prime}$ we get  $y^{\,\prime}y^{\,\prime\prime}=f(y)y^{\,\prime}$.  Then we can integrate both sides (with respect to the independent variable).  Let's determine what we get when we do this, Using that $y^{\,\prime\prime} \mathrm{d}t=\mathrm{d}(y^{\,\prime})$ and $y^{\,\prime} \mathrm{d}t=\mathrm{d}y$.  The result is a separable differential equation.
